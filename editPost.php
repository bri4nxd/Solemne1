            ...
            <div class="card">
                <div class="card-body">
                    <form action="controllers/updatePostController.php" method="POST">
                        <div>
                            <label>Autor</label>
                            <input type="text" name="autor" value="<?= $post[0]->autor ?> " class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="contenido"><?php echo $post[0]->contenido ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Fecha</label>
                            <input type="date" name="fecha" value="<?= $post[0]->fecha ?> " class="form-control">
                        </div>
